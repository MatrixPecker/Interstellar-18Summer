...
Parkinglot::Parkinglot() {
    ...
    sh[2]=new class Rectangle({0.26f,-0.02f},{0.86f,0.02f},r,g,b);
    ...
    sh[21]=new class Line({0.26f,-0.38f},{0.26f,-0.22f},r,g,b);
    sh[22]=new class Line({0.38f,-0.38f},{0.38f,-0.22f},r,g,b);
    sh[23]=new class Line({0.5f,-0.38f},{0.5f,-0.22f},r,g,b);
    sh[24]=new class Line({0.62f,-0.38f},{0.62f,-0.22f},r,g,b);
    sh[25]=new class Line({0.74f,-0.38f},{0.74f,-0.22f},r,g,b);
    sh[26]=new class Line({0.86f,-0.38f},{0.86f,-0.22f},r,g,b);
    ...
    sh[36]=new class Line({0.26f,0.38f},{0.26f,0.22f},r,g,b);
    sh[37]=new class Line({0.38f,0.38f},{0.38f,0.22f},r,g,b);
    sh[38]=new class Line({0.5f,0.38f},{0.5f,0.22f},r,g,b);
    sh[39]=new class Line({0.62f,0.38f},{0.62f,0.22f},r,g,b);
    sh[40]=new class Line({0.74f,0.38f},{0.74f,0.22f},r,g,b);
    sh[41]=new class Line({0.86f,0.38f},{0.86f,0.22f},r,g,b);
...
void Parkinglot::parkdraw() {for(int i=0;i<=65;i++) sh[i]->draw();}
